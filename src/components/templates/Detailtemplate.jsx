              ...
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-5 mb-6 md:mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
                  <button
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-6 rounded-xl shadow-md transition-all duration-300 active:scale-95 cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a
                    ...
                    className="w-full sm:w-auto flex items-center justify-center gap-2 bg-[#0038FF] hover:bg-blue-800 text-white font-bold py-3 px-6 rounded-xl shadow-md transition-all duration-300 active:scale-95 cursor-pointer"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-5 w-5 sm:h-6 sm:w-6"
            ...
            <div className="bg-gray-50 p-6 sm:p-8 md:p-10 rounded-3xl border border-gray-200 shadow-sm mx-4 sm:mx-6 lg:mx-8">
              <div className="mb-8">
                ...
                <p className="text-gray-500 font-medium text-sm sm:text-base">
                  Rekomendasi destinasi wisata serupa yang memiliki
                  karakteristik konten mirip.
                </p>
              </div>
